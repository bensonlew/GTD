...
** DONE 对接树形文件修改
   ...
   :END:      
** TODO 组装结果异常核查, 同个项目， fastq 内部顺序变了之后组装结果差异大，一个的比对率异常， 非正常比对比例高
...
** DONE 数据库升级文档修改
   ...
   :END:      
** NEXT smallRNA升级，注释模块 添加相关代码， 测试

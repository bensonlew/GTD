...
*** DONE GSEA测试pre rank
    ...
    :END:      
*** TODO gsea 使用基因集会经常不出结果
*** TODO 没有基因name的应该删除还是保留
*** TODO 有参接口流程调通
* 无参考云平台优化
** DONE 安装几个组装软件
   CLOSED: [2019-05-26 Sun 11:06]
...
** TODO 查看蛋白kegg的结果统计数量与html标记数量不一致的问题， 原因是注释的数据库使用的是旧版的，html使用新版的
...
* TODO Emacs 自动提示错误 Warning (flycheck): Syntax checker python-pylint reported too many errors (801) and is disabled.

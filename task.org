...
** do 注释package,workflow,tools, mongo, 文档
** do 富集package,workflow,tools, mongo, 文档
** reactome 注释package,workflow,tools, mongo, 文档
** reactome 富集package,workflow,tools, mongo, 文档
** 添加blast结果注释
...
** emacs 拼写检查有没有可能换行时添加， jedi自动补全慢
* 其它

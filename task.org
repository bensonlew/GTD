...
** DONE 有参hisat 部分基因组运行过慢问题， 测试新版软件 无效 splice 引起
   CLOSED: [2020-10-19 Mon 08:59] SCHEDULED: <2020-10-12 Mon>
   :LOGBOOK:  
   - State "DONE"       from "NEXT"       [2020-10-19 Mon 08:59]
   :END:      
** TODO 无参优化, transrate 修改逻辑  SALMON 旧版生成bam有问题(序列数量特别多时)， 此时 quant.sf 不会被重命名为 组装名_quant.sf 删除相关文件生成代码然使用hisat的bam文件
** DONE smallRNA 问题 表达没有插入
   CLOSED: [2020-10-27 Tue 08:20] SCHEDULED: <2020-10-26 Mon>
   :LOGBOOK:  
   - State "DONE"       from "NEXT"       [2020-10-27 Tue 08:20]
   :END:      
** TODO lncRNA stringtie 运行速度慢
   SCHEDULED: <2020-10-27 Tue>
** small RNA 近源物种预测的 可以找到其在该基因组上的坐标么
...
** DONE 蛋白修改后问题
   ...
   :END:      
** TODO diamond2 数据库研究， 比对差异 /mnt/ilustre/users/sanger-dev/workspace/20201019/Itraqtmt_tsg_248666/Diamond/Diamond4/output miniconda 可以安装上， 运行速度待研究
...
** DONE lncrna 原核 全转录组上线
   ...
   - State "DONE"       from "NEXT"       [2020-10-26 Mon 08:29]
   :END:      
** TODO to_file阶段工作流被卡主问题 进程24118,worker tsg_38079_9121_512，运行300秒尚未开始，可能被卡住，尝试强制结束并重新运行, 解决办法是 list 改为set 加快速度t
...
** DONE 无参组装结果不一致的问题 diamond软件问题
   ...
   - State "DONE"       from "NEXT"       [2020-10-26 Mon 09:28]
   :END:      
** TODO 无参transrate软件问题 
   SCHEDULED: <2020-10-21 Wed>
** TODO 无参busco 指标添加， 注释结果目录修改, 样本名空格判断
   SCHEDULED: <2020-10-27 Tue>
...
2020-09-08 19:01:43:sanger-dev:/mnt/ilustre/users/sanger-dev/sg-users/liubinxu/work/SangerBiocluster/:git commit -m "和并 tool_lab"



** 导表失败Failed to insert records into table sg_exp_detail as: batch op errors occurred

** pd.concat 无视索引列的名称

** 框架中的nr2GO 内存溢出被杀掉， 重新投递，如果没有被杀，则会被卡死
* 其它
